        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1">
                    <form action="/customer/ordertaken" method="post" >
                        @csrf
                ...
                <div class="col-md-3 col-md-offset-1">
                    ...
                    <form action="/customer/foodrecommand" method="post" enctype="multipart/form-data">
                        @csrf
                        <input class="form-control" name="obtainbmi" placeholder="enter your obtain BMI"><br>
                        <input type="submit" value="get_recommend">
